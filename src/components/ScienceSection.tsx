      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            <span className="text-foreground text-4xl">GLP Compass ™ </span>
...
Understanding Your Biology</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {biomarkers.map((marker, index) => <div key={index} className="glass-card rounded-3xl p-8 text-center hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 group" style={{
